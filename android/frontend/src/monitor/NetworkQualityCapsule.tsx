...
import { getLatencyColor, getLatencyLevel, extractGatewayLatency, extractExternalLatency } from '@/lib/latency'
...
export const NetworkQualityCapsule = memo(function NetworkQualityCapsule({ networkQuality }: NetworkQualityCapsuleProps) {
  ...
  // busy/unknown 但已有延迟数据(增量推送,终态未到)时按延迟推断等级,
  // 否则慢网络下胶囊永远显示"检测中"(真机 2026-09-09)
