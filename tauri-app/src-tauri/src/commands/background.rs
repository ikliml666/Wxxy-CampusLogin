...
use crate::monitor::latency::spawn_latency_test_loop;
use crate::monitor::auto_auth::run_auto_login_on_start;
...
pub fn run_startup_tasks(app_handle: &AppHandle) {
    ...
    if config.enable_background_check {
        ...
        tauri::async_runtime::spawn(async move {
            ...
            if let Err(e) = watcher::start_background_check_inner(&app_h, &s) {
