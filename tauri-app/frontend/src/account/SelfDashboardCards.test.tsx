...
import { SelfDashboardCards } from './SelfDashboardCards'
...
function renderCards(account = ' 24380001 ', password = ' 123456 ') {
  return render(<SelfDashboardCards account={account} password={password} />)
}

describe('SelfDashboardCards', () => {
  it('未填凭据时提示且刷新按钮禁用', () => {
  ...
  it('刷新后表格渲染并按协议格式化（MAC/时长/流量/终端类型/计费方式）', async () => {
    ...
    expect(querySelfDashboard).toHaveBeenCalledWith({ account: '24380001', password: '123456' })
