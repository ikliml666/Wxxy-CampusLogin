export const QUALITY_CONFIG = {
  ...
  disabled: { label: '已禁用', color: 'text-muted-foreground', bg: 'bg-muted', border: 'border-border', borderBg: 'bg-muted', icon: 'Ban', hex: '#94a3b8', activeBars: 0, glow: 'rgba(148,163,184,0.35)' },
  busy:     { label: '检测中', color: 'text-muted-foreground', bg: 'bg-muted', border: 'border-border', borderBg: 'bg-muted', icon: 'Loader2', hex: '#94a3b8', activeBars: 0, glow: 'rgba(148,163,184,0.35)' },
} as const
